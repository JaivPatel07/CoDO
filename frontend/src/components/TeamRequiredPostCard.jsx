    ...
    <div className="bg-white rounded-3xl border border-slate-200 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300">
      ...
      <div className="p-6 pb-1 flex justify-between">
        ...
        <div className="relative" ref={menuRef}>
          ...
          <div
            className={`absolute right-0 top-12 w-60 bg-white rounded-2xl border border-gray-200 shadow-2xl overflow-hidden z-50 origin-top-right transition-all duration-200 ${
              menuOpen
          ...
          >
            <button
              onClick={handleSave}
              className="flex items-center gap-3 w-full px-5 py-3 hover:bg-gray-50 transition"
            >
              <Bookmark
                size={18}
            ...
            <button
              ...
              className="flex items-center gap-3 w-full px-5 py-3 text-red-500 hover:bg-red-50 transition"
            >
              <Flag size={18} />
              Report Post
            </button>
      ...
      {/* POST TEXT */}
      <div className="px-6">
        <p className="text-slate-700 leading-8 text-lg">{posttext}</p>
      </div>
