...
import { toggle_save_collab } from "../api/save_apis";

export default function CollabrationPostCard({ project, onToggleSaved }) {
                ...
                <div className="flex justify-between items-start mb-3">
                    ...
                    <button
                        onClick={async (e) => { 
                            ...
                            try {
                                await toggle_save_collab(project.id);
                                onToggleSaved?.(project.id, newState);
                            } catch {
                                setIsBookmarked(!newState);
                            }
                        }}
