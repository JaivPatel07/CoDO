...
const Suggestions = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-4">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2 flex items-center gap-2 text-slate-900">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 bg-slate-50 rounded-3xl border border-slate-200">
          <h3 className="text-xl font-semibold text-slate-700">No recommendations right now</h3>
          <p className="text-slate-500 mt-2">Check back later for new connections.</p>
        </div>
      ) : (
        /* Grid */
