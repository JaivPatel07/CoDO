...
export function SignupChoicePage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-indigo-50/50 via-white to-emerald-50/50 px-4 py-10 text-slate-950 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col items-center text-center z-10">
        ...
        >
            <span className="grid h-10 w-10 place-items-center rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 text-white shadow-md shadow-indigo-600/10">
            <svg
              className="h-6 w-6"
              fill="none"
              stroke="currentColor"
        ...
        <div className="mt-12 grid w-full gap-6 md:grid-cols-2">
          ...
          <Link
            to="/signup/student"
            className="group relative flex flex-col items-start rounded-[28px] border border-white/70 bg-white/85 p-8 text-left shadow-xl shadow-slate-200/60 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-indigo-300"
          >
          ...
          <Link
            ...
            className="group relative flex flex-col items-start rounded-[28px] border border-white/70 bg-white/85 p-8 text-left shadow-xl shadow-slate-200/60 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-emerald-300"
          >
            ...
            <p className="mt-3 leading-relaxed text-slate-500 text-left text-sm">
              Publish opportunities, share events, and connect with talented
              students through your organization account.
            </p>
...
export function StudentSignupPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-indigo-50/50 via-white to-slate-100 px-4 py-8 text-slate-950 flex items-center justify-center relative overflow-hidden">
      <div className="absolute top-[-10%] left-[-10%] h-[350px] w-[350px] rounded-full bg-indigo-200/50 blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-[-10%] right-[-10%] h-[350px] w-[350px] rounded-full bg-cyan-100/60 blur-[100px] pointer-events-none"></div>

      <div className="mx-auto grid w-full max-w-6xl overflow-hidden rounded-[30px] border border-white/70 bg-white/70 shadow-xl shadow-slate-200/60 backdrop-blur-xl md:grid-cols-[1.05fr_0.95fr] z-10">
        <section className="hidden md:flex flex-col justify-center border-r border-slate-200/70 bg-white/55 p-8">
        ...
        <section className="mx-auto w-full max-w-md p-6 sm:p-8">
          <Link to="/" className="mb-6 flex items-center gap-2.5 text-2xl font-black text-indigo-600">
            <span className="grid h-9 w-9 place-items-center rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 text-white shadow-sm">C</span>
            <span className="text-slate-900">CoDO</span>
          </Link>
          ...
          <p className="mt-6 text-center text-sm font-semibold text-slate-500">
            Already have an account?
            <Link to="/login" state={{ accountType: 'student' }} className="ml-2 font-bold text-indigo-600 hover:text-indigo-800 transition-colors">
              Login
            </Link>
          </p>
        </section>
...
export function OrganizationSignupPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-emerald-50/50 via-white to-slate-100 px-4 py-8 text-slate-950 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="mx-auto grid w-full max-w-6xl overflow-hidden rounded-[30px] border border-white/70 bg-white/70 shadow-xl shadow-slate-200/60 backdrop-blur-xl md:grid-cols-[1.05fr_0.95fr] z-10">
        <section className="hidden md:flex flex-col justify-center border-r border-slate-200/70 bg-white/55 p-8">
          ...
          <p className="mt-3 leading-relaxed text-slate-500 text-sm">
            Organization accounts can publish opportunities, share events, and connect with student talent.
          </p>
          <div className="mt-8 grid gap-4">
            <div className="rounded-2xl bg-white/70 border border-slate-100 p-4 shadow-sm">
        ...
        <section className="mx-auto w-full max-w-md p-6 sm:p-8">
          <Link to="/" className="mb-6 flex items-center gap-2.5 text-2xl font-black text-emerald-600">
            <span className="grid h-9 w-9 place-items-center rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-sm">C</span>
            <span className="text-slate-900">CoDO</span>
          </Link>
          ...
          <p className="mt-6 text-center text-sm font-semibold text-slate-500">
            Already have an account?
            <Link to="/login" state={{ accountType: 'organization' }} className="ml-2 font-bold text-emerald-600 hover:text-emerald-800 transition-colors">
              Login
            </Link>
          </p>
        </section>
