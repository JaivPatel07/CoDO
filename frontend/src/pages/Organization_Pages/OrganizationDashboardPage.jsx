...
return (
        <div className={`group bg-white rounded-2xl border p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-violet-500/10 dark:bg-slate-900 dark:border-slate-800 ${meta.borderColor}`}>
...
{/* Recent Events Card */}
        <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden dark:bg-slate-900 dark:border-slate-800">
          {/* Card Header */}
        ...
        <div className="space-y-3">
          ...
          {/* Mini analytics card */}
          {analytics?.cards && (
            <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-5 dark:bg-slate-900 dark:border-slate-800">
              <h3 className="text-sm font-bold text-slate-900 mb-4 dark:text-slate-100">
                Community Snapshot
              </h3>
              <div className="space-y-3">
                {[
