...
function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-slate-50 pt-16 pb-12 lg:pt-24 lg:pb-16">
      ...
      <div className="relative z-10 mx-auto grid max-w-[1280px] gap-12 px-6 lg:grid-cols-2 lg:items-center xl:px-8">
        <motion.div initial="hidden" animate="visible" variants={fadeUp} className="max-w-2xl">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-violet-200 bg-violet-50 px-3 py-1 text-xs font-bold text-violet-700">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            ...
            <a href="#platform" className="inline-flex items-center justify-center gap-2 rounded-xl border-2 border-slate-200 bg-white px-6 py-4 text-base font-bold text-slate-700 transition-colors hover:border-violet-200 hover:bg-violet-50 hover:text-violet-700">
        ...
        <motion.div 
          className="relative lg:ml-auto w-full max-w-[600px] rounded-2xl border border-slate-200/60 bg-white/60 p-4 shadow-2xl backdrop-blur-xl"
        ...
        >
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="col-span-2 flex items-center gap-4 rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-transform hover:-translate-y-1">
              <img src="https://i.pravatar.cc/150?img=68" alt="Profile" className="h-14 w-14 shrink-0 rounded-full border-2 border-slate-100 object-cover" />
              <div className="flex-1">
                <h4 className="text-base font-bold text-slate-900">Alex Chen</h4>
                <p className="text-xs text-slate-500">Computer Science • Junior</p>
                <div className="mt-2 flex gap-2">
                  <span className="rounded bg-violet-100 px-2 py-0.5 text-[10px] font-bold text-violet-700">React</span>
              ...
              <div className="hidden sm:block">
                <button className="rounded-lg bg-slate-900 px-4 py-2 text-xs font-bold text-white transition-colors hover:bg-slate-800">Connect</button>
              </div>
            </div>

            {/* Project Card */}
            <div className="rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-transform hover:-translate-y-1">
              <div className="mb-2 flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold text-slate-400 text-right">1 Role Open</span>
              </div>
              <h4 className="text-sm font-bold text-slate-900 mt-2">Campus Marketplace</h4>
              <div className="mt-3 flex -space-x-2">
                ...
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-100 border-2 border-white text-[10px] font-bold text-slate-600">+2</div>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-transform hover:-translate-y-1">
              <div className="mb-2 flex items-center justify-between">
                <span className="inline-block rounded-md bg-emerald-50 px-2 py-1 text-[10px] font-bold uppercase tracking-wider text-emerald-600">Hackathon</span>
                <span className="text-[10px] font-bold text-slate-400">3d left</span>
              </div>
              <h4 className="text-sm font-bold text-slate-900 mt-2">Build for Good 2026</h4>
            ...
            {/* Chat preview */}
            <div className="col-span-2 rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-transform hover:-translate-y-1">
              <div className="flex items-center gap-2 border-b border-slate-50 pb-2 mb-3">
                <MessageCircle size={14} className="text-slate-400" />
                <span className="text-xs font-bold text-slate-600">Team Chat - Marketplace App</span>
              </div>
              <div className="space-y-2">
                <div className="flex gap-2">
                  <img src="https://i.pravatar.cc/150?img=32" className="h-6 w-6 shrink-0 rounded-full" alt="avatar" />
                  <div className="rounded-r-lg rounded-bl-lg bg-slate-100 px-3 py-2 text-xs text-slate-700">Anyone ready to start on the Auth flow?</div>
                </div>
...
function TickerSection() {
  return (
    <div className="border-y border-slate-200 bg-white py-3 overflow-hidden flex">
      <motion.div 
        className="flex whitespace-nowrap gap-10 px-10 text-xs font-semibold text-slate-600"
        animate={{ x: ["0%", "-50%"] }}
        transition={{ repeat: Infinity, ease: "linear", duration: 30 }}
      >
        {[...Array(2)].map((_, i) => (
          <div key={i} className="flex gap-10">
            <span className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-emerald-500" /> Live on CoDO: 128 students looking for teammates</span>
            <span className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-emerald-500" /> 54 open projects looking for contributors</span>
            <span className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-emerald-500" /> 21 hackathons happening this week</span>
            <span className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-emerald-500" /> 300+ Active organizations hiring</span>
          </div>
        ))}
      </motion.div>
    </div>
  ...
  return (
    <section className="border-y border-slate-200 bg-white py-8">
      <div className="mx-auto max-w-[1280px] px-6 text-center">
        <h3 className="mb-5 text-sm font-bold uppercase tracking-widest text-slate-400">Built for Student Communities</h3>
        <div className="flex flex-wrap justify-center gap-4 md:gap-8">
          {tags.map((tag) => (
            <div key={tag} className="rounded-full border border-slate-100 bg-slate-50 px-6 py-2.5 text-sm font-semibold text-slate-600 shadow-sm transition-colors hover:border-slate-200 hover:bg-slate-100">
              {tag}
            </div>
          ))}
        </div>
        <p className="mt-5 text-xs font-semibold text-slate-400">More communities joining soon.</p>
      </div>
    </section>
  );
}
    ...
    <section className="bg-slate-50 py-16">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-8">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 lg:row-span-2 flex flex-col justify-between group rounded-3xl border border-slate-200 bg-white p-7 transition-all hover:shadow-xl hover:shadow-violet-600/10">
            <div>
              <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-100 text-blue-600">
                <Users size={28} strokeWidth={2.5} />
              </div>
              <h3 className="text-2xl font-black text-slate-900">Find Teammates</h3>
              <p className="mt-3 text-base leading-relaxed text-slate-600 max-w-md">Discover students with the exact skills you need for your next big idea. Filter by major, technical stack, or interests.</p>
            </div>
            <div className="mt-8 overflow-hidden rounded-2xl border border-slate-100 shadow-inner h-40 bg-slate-50 flex items-center justify-center relative">
          ...
          {/* Discover Events */}
          <div className="group rounded-3xl border border-slate-200 bg-white p-7 transition-all hover:shadow-xl hover:shadow-violet-600/10">
            ...
            <h3 className="text-xl font-black text-slate-900">Discover Events</h3>
            <p className="mt-2 text-sm leading-relaxed text-slate-600">Never miss a campus hackathon, workshop, or tech meetup again.</p>
          </div>

          {/* Chat Together */}
          <div className="group rounded-3xl border border-slate-800 bg-slate-900 p-7 text-white transition-all hover:shadow-xl hover:shadow-violet-600/20">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-400">Communicate seamlessly with your team without switching apps.</p>
          </div>

          {/* Build Projects */}
          <div className="lg:col-span-3 group flex flex-col md:flex-row items-center gap-7 rounded-3xl border border-violet-100 bg-violet-50 p-7 transition-all hover:shadow-xl hover:shadow-violet-600/10">
             <div className="flex-1">
               <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-violet-600 text-white">
                <Rocket size={28} strokeWidth={2.5} />
              </div>
              <h3 className="text-2xl font-black text-slate-900">Build Projects & Portfolio</h3>
              <p className="mt-3 text-base leading-relaxed text-slate-600">Collaborate effectively, showcase your work, and build a stellar portfolio that lands you opportunities.</p>
             </div>
             <div className="w-full md:w-1/3 mt-4 md:mt-0">
               <div className="rounded-2xl bg-white p-5 shadow-sm border border-violet-100">
                  <div className="flex gap-2 mb-3">
                    <span className="h-2.5 w-12 rounded-full bg-violet-200"/>
                    <span className="h-2.5 w-8 rounded-full bg-blue-200"/>
                  </div>
                  <div className="h-20 w-full rounded-xl bg-slate-50 border border-slate-100 mb-3 flex items-center justify-center text-slate-300">
                    <Code2 size={24} />
                  </div>
...
function PlatformPreviewSection() {
  return (
    <section id="platform" className="overflow-hidden bg-slate-900 py-16 text-white">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-8">
        <div className="mb-10 text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-base text-slate-400">See how CoDO helps students collaborate, network, and grow their careers.</p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col rounded-3xl border border-slate-800 bg-slate-950/50 p-6 lg:col-span-2">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-slate-400">Showcase skills, projects, achievements and interests to help teammates find you.</p>
            </div>
            
            <div className="mt-auto rounded-xl border border-slate-800 bg-slate-900 p-6 shadow-2xl">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <button className="hidden sm:block rounded-lg bg-white px-5 py-2.5 text-sm font-bold text-slate-900">Connect</button>
              </div>
              ...
              <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-4 border-t border-slate-800 pt-6">
                ...
                <div>
                  <p className="text-xs text-slate-500 uppercase font-bold tracking-wider">Hackathons</p>
                  <p className="mt-1 text-lg font-bold text-white">5 Won</p>
                </div>
                <div className="col-span-2">
                  <p className="text-xs text-slate-500 uppercase font-bold tracking-wider">Top Project</p>
          ...
          <div className="flex flex-col rounded-3xl border border-slate-800 bg-slate-950/50 p-6">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-slate-400">Find the perfect candidates for your projects with precision matching.</p>
            </div>
            
            <div className="mt-auto space-y-3">
              <div className="rounded-xl border border-slate-800 bg-slate-900 p-4 transition-colors hover:bg-slate-800/80">
                <div className="flex justify-between items-start">
                  <div>
                    <h5 className="text-sm font-bold text-white">Need React Developer</h5>
                    <p className="text-xs text-slate-400 mt-1">Project: AI Resume Builder</p>
                  </div>
                  <span className="bg-emerald-500/10 text-emerald-400 text-[10px] font-bold px-2 py-1 rounded">Open</span>
                </div>
              ...
              <div className="rounded-xl border border-slate-800 bg-slate-900 p-4 transition-colors hover:bg-slate-800/80">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-1">Project: Green Campus</p>
                  </div>
                  <span className="bg-emerald-500/10 text-emerald-400 text-[10px] font-bold px-2 py-1 rounded">Open</span>
                </div>
              </div>
          ...
          <div className="flex flex-col rounded-3xl border border-slate-800 bg-slate-950/50 p-6 lg:col-span-2">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-slate-400">Coordinate with your teammates directly without ever switching apps.</p>
            </div>
            
            <div className="mt-auto rounded-xl border border-slate-800 bg-slate-900 p-6">
          ...
          <div className="flex flex-col rounded-3xl border border-slate-800 bg-slate-950/50 p-6">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-slate-400">Never miss out on hackathons, workshops, and meetups.</p>
            </div>
            
            <div className="mt-auto rounded-xl border border-slate-800 bg-slate-900 overflow-hidden">
              <div className="bg-gradient-to-br from-emerald-500 to-teal-700 p-4">
                <span className="bg-white/20 px-2 py-1 text-[10px] font-bold text-white rounded">Hackathon</span>
        ...
        <div className="mt-12 text-center">
          ...
          <Link to="/signup" className="inline-block rounded-xl bg-violet-600 px-7 py-3 text-base font-bold text-white shadow-lg shadow-violet-600/30 transition-colors hover:bg-violet-500">
            Join Free Today
          </Link>
        </div>
    ...
    <section className="bg-white py-16">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-8">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {reasons.map((r, i) => (
            <div key={i} className="group flex flex-col rounded-2xl border border-slate-200 bg-slate-50 p-6 transition-all hover:bg-white hover:shadow-lg hover:shadow-violet-600/10 hover:border-violet-200">
              <div className="mb-4 flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-white shadow-sm border border-slate-200 text-slate-600 transition-colors group-hover:bg-violet-600 group-hover:text-white group-hover:border-violet-600">
                <r.icon size={22} strokeWidth={2.5} />
              </div>
              <h4 className="text-lg font-black text-slate-900">{r.title}</h4>
              <p className="mt-2 text-sm font-medium text-slate-600 leading-relaxed">{r.desc}</p>
            </div>
          ))}
        </div>
      </div>
    ...
    <section className="bg-white py-16">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-8">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {/* Students */}
          <div className="flex flex-col rounded-3xl border border-violet-100 bg-violet-50 p-6 sm:p-8">
            ...
            <p className="mt-2 text-sm text-slate-600">Accelerate your learning, build a real-world portfolio, and network with peers.</p>
          ...
          {/* Organizations */}
          <div className="flex flex-col rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-lg shadow-slate-200/50">
            ...
            <h3 className="text-xl font-black text-slate-900">Grow Your Student Community</h3>
            <p className="mt-2 text-sm text-slate-600">Connect with talented students, promote your initiatives, and build stronger campus communities.</p>
            ...
            <ul className="mt-5 mb-7 flex-1 space-y-2.5">
              {["Find talented students", "Connect with active communities", "Build stronger teams", "Reach the right audience", "Grow your campus presence", "Discover future leaders"].map(item => (
                <li key={item} className="flex items-center gap-3 text-sm font-semibold text-slate-700">
                  <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-slate-100 text-slate-700"><Check size={11} /></div>
                  {item}
                </li>
              ))}
            </ul>
            
            <Link to="/signup?type=org" className="mt-auto block w-full rounded-xl bg-slate-900 px-5 py-3 text-center text-sm font-bold text-white transition-colors hover:bg-slate-800">Register Organization</Link>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="bg-white py-16">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-8">
        <div className="mb-8 text-center max-w-3xl mx-auto">
          <p className="text-sm font-semibold text-slate-600">Check out what's happening right now in the CoDO ecosystem.</p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          {/* Featured Event */}
          <div>
            <h4 className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500">Featured Event</h4>
            <div className="rounded-xl border border-slate-200 bg-white overflow-hidden shadow-sm flex flex-col h-[320px]">
              <div className="bg-violet-600 p-6 text-white flex-1 flex flex-col justify-center">
                <div>
                  <span className="inline-block rounded-full bg-white/20 px-3 py-1 text-[10px] font-bold">Official Event</span>
                </div>
              ...
              <div className="p-6 bg-white flex-1 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between mt-4">
                  <div className="flex -space-x-2">
                    {[1,2,3].map(i => (
                      <div key={i} className="h-7 w-7 rounded-full bg-slate-200 border-2 border-white" />
                    ))}
                  ...
                  <button className="rounded-lg bg-violet-100 px-4 py-2 text-xs font-bold text-violet-700 hover:bg-violet-200 transition-colors">
                    View Details
                  </button>
                </div>
              </div>
          ...
          {/* Open Roles */}
          <div>
            <h4 className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500">Open Roles</h4>
            <div className="flex flex-col gap-4">
              {roles.map((role, i) => (
                <div key={i} className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm flex items-center justify-between">
                  <div>
                    <h5 className="text-sm font-bold text-slate-900">{role.title}</h5>
                    <p className="text-xs text-slate-500 mt-1">{role.project}</p>
                  </div>
          ...
          {/* Active Student */}
          <div>
            <h4 className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500">Active Student</h4>
            <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm h-[320px] flex flex-col">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {["React", "Node.js", "AWS", "Python"].map(skill => (
                  <span key={skill} className="rounded bg-slate-100 px-2.5 py-1 text-[10px] font-semibold text-slate-600">
                    {skill}
                  </span>
                ))}
              </div>
              ...
              <div className="flex justify-around text-center mb-auto">
                <div>
                  ...
                  <p className="text-[9px] font-bold uppercase tracking-wider text-slate-400 mt-1">Projects</p>
                </div>
                <div>
                  <p className="text-lg font-bold text-violet-700">850+</p>
                  <p className="text-[9px] font-bold uppercase tracking-wider text-slate-400 mt-1">Points</p>
                </div>
              </div>
              
              <button className="mt-4 w-full rounded-lg border border-violet-200 bg-white px-4 py-2.5 text-xs font-bold text-violet-700 hover:bg-violet-50 transition-colors">
                View Profile
              </button>
            </div>
          </div>
    ...
    <section className="bg-slate-900 py-16 text-white">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="mt-4 text-base text-slate-400">Your journey from student to shipped product.</p>
        </div>
    ...
    <section className="bg-white py-16">
      <div className="mx-auto max-w-4xl px-6 xl:px-8">
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200">
          <div className="grid grid-cols-2 border-b border-slate-200 bg-slate-50 p-4 text-sm font-bold uppercase tracking-wider text-slate-400">
            <div>Other Platforms</div>
            <div className="text-violet-600">CoDO</div>
          </div>
          <div className="divide-y divide-slate-100">
            {comparisons.map((row, i) => (
              <div key={i} className="grid grid-cols-2 px-4 py-3.5 hover:bg-slate-50">
    ...
    <section className="bg-slate-50 py-16">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-8">
        ...
        <div className="mx-auto max-w-2xl rounded-3xl bg-gradient-to-br from-violet-600 to-fuchsia-600 p-1">
          <div className="rounded-[23px] bg-white p-8 text-center shadow-xl">
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-violet-100 text-2xl">🚀</div>
            <h3 className="text-2xl font-black text-slate-900">Your Success Story Could Be Here</h3>
            <div className="mt-5 space-y-2 text-base font-semibold text-slate-600">
            ...
            <Link to="/signup" className="mt-6 inline-block rounded-xl bg-slate-900 px-7 py-3 font-bold text-white transition-colors hover:bg-slate-800">Start Your Story</Link>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="bg-white py-16">
      <div className="mx-auto max-w-3xl px-6 xl:px-8">
        ...
        <div className="space-y-3">
          {faqs.map((q, index) => (
            <div key={index} className="rounded-xl border border-slate-200 bg-white overflow-hidden transition-all hover:border-violet-200">
              <button 
                onClick={() => setOpenFaq(openFaq === index ? null : index)} 
                className="flex w-full items-center justify-between px-5 py-4 text-left text-sm font-bold text-slate-900 focus:outline-none"
              >
                {q}
                <ChevronDown size={18} className={`shrink-0 text-slate-400 transition-transform duration-200 ${openFaq === index ? "rotate-180 text-violet-600" : ""}`} />
              </button>
              <AnimatePresence>
                {openFaq === index && (
                  <motion.div 
                  ...
                  >
                    <p className="border-t border-slate-100 px-5 py-4 text-sm text-slate-600 leading-relaxed">{getAnswer(q)}</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
  ...
  return (
    <section className="py-16 px-6 xl:px-8">
      <div className="mx-auto max-w-[1280px]">
        <div className="relative overflow-hidden rounded-3xl bg-slate-900 px-6 py-16 text-center text-white shadow-2xl md:px-16">
          <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-3xl">
            ...
            <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
              <Link to="/signup" className="rounded-xl bg-violet-600 px-7 py-3.5 text-base font-bold text-white shadow-lg shadow-violet-600/25 transition-colors hover:bg-violet-500">
                Join as Student
              </Link>
              <Link to="/signup?type=org" className="rounded-xl bg-white px-7 py-3.5 text-base font-bold text-slate-900 transition-colors hover:bg-slate-100">
