...
function SectionTitle({ title, subtitle, centered = true }) {
  return (
    <div className={`mb-8 ${centered ? "mx-auto text-center" : "text-left"} max-w-3xl`}>
      ...
      {subtitle && <p className="mt-3 text-base leading-relaxed text-slate-600 dark:text-slate-400">{subtitle}</p>}
    </div>
  );
}
...
function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-slate-50 dark:bg-slate-950 pt-16 pb-12 lg:pt-24 lg:pb-16">
      ...
      <div className="relative z-10 mx-auto grid max-w-[1280px] gap-12 px-6 lg:grid-cols-2 lg:items-center xl:px-8">
        <motion.div initial="hidden" animate="visible" variants={fadeUp} className="max-w-2xl">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-violet-200 bg-violet-50 px-3 py-1 text-xs font-bold text-violet-700 dark:text-violet-300">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            <Link to="/signup" className="group inline-flex items-center justify-center gap-2 rounded-xl bg-violet-600 px-6 py-4 text-base font-bold text-white shadow-xl shadow-violet-600/20 transition-all hover:-translate-y-1 hover:bg-violet-700 hover:shadow-violet-600/30 dark:hover:bg-violet-500">
              <GraduationCap size={20} /> Join as Student
            </Link>
            <a href="#platform" className="inline-flex items-center justify-center gap-2 rounded-xl border-2 border-slate-200 bg-white dark:bg-slate-800 px-6 py-4 text-base font-bold text-slate-700 dark:text-slate-200 transition-colors hover:border-violet-200 hover:bg-violet-50 hover:text-violet-700 dark:hover:bg-violet-900/30 dark:hover:text-violet-300">
        ...
        <motion.div 
          className="relative lg:ml-auto w-full max-w-[600px] rounded-2xl border border-slate-200/60 bg-white/60 dark:bg-slate-800/60 p-4 shadow-2xl backdrop-blur-xl"
          initial={{ opacity: 0, x: 40, scale: 0.95 }}
          animate={{ opacity: 1, x: 0, scale: 1 }}
          transition={{ duration: 0.8, ease: "easeOut", delay: 0.2 }}
        >
          {/* Mac window controls */}
          <div className="mb-4 flex items-center gap-2 border-b border-slate-100 dark:border-slate-700 pb-3">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="col-span-2 flex items-center gap-4 rounded-xl border border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 shadow-sm transition-transform hover:-translate-y-1">
              <img src="https://i.pravatar.cc/150?img=68" alt="Profile" className="h-14 w-14 shrink-0 rounded-full border-2 border-slate-100 dark:border-slate-700 object-cover" />
              <div className="flex-1">
                <h4 className="text-base font-bold text-slate-900 dark:text-slate-100">Alex Chen</h4>
                <p className="text-xs text-slate-500 dark:text-slate-400">Computer Science • Junior</p>
                <div className="mt-2 flex gap-2">
                  <span className="rounded bg-violet-100 px-2 py-0.5 text-[10px] font-bold text-violet-700 dark:bg-violet-900/50 dark:text-violet-300">React</span>
                  <span className="rounded bg-blue-100 px-2 py-0.5 text-[10px] font-bold text-blue-700 dark:bg-blue-900/50 dark:text-blue-300">Node.js</span>
                  <span className="rounded bg-emerald-100 px-2 py-0.5 text-[10px] font-bold text-emerald-700 dark:bg-emerald-900/50 dark:text-emerald-300">UI/UX</span>
                </div>
              </div>
            ...
            {/* Project Card */}
            <div className="rounded-xl border border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 shadow-sm transition-transform hover:-translate-y-1">
              <div className="mb-2 flex items-center justify-between">
                <span className="inline-block rounded-md bg-blue-50 dark:bg-blue-900/30 px-2 py-1 text-[10px] font-bold uppercase tracking-wider text-blue-600 dark:text-blue-400">Project</span>
                <span className="text-[10px] font-bold text-slate-400 dark:text-slate-300 text-right">1 Role Open</span>
              </div>
              <h4 className="text-sm font-bold text-slate-900 dark:text-slate-100 mt-2">Campus Marketplace</h4>
              <div className="mt-3 flex -space-x-2">
                <img src="https://i.pravatar.cc/150?img=32" className="h-6 w-6 rounded-full border-2 border-white dark:border-slate-800" alt="member" />
                <img src="https://i.pravatar.cc/150?img=12" className="h-6 w-6 rounded-full border-2 border-white dark:border-slate-800" alt="member" />
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 border-2 border-white dark:border-slate-800 text-[10px] font-bold text-slate-600 dark:text-slate-300">+2</div>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 shadow-sm transition-transform hover:-translate-y-1">
              <div className="mb-2 flex items-center justify-between">
                <span className="inline-block rounded-md bg-emerald-50 dark:bg-emerald-900/30 px-2 py-1 text-[10px] font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400">Hackathon</span>
            ...
            {/* Chat preview */}
            <div className="col-span-2 rounded-xl border border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 shadow-sm transition-transform hover:-translate-y-1">
              <div className="flex items-center gap-2 border-b border-slate-50 dark:border-slate-700 pb-2 mb-3">
                <MessageCircle size={14} className="text-slate-400 dark:text-slate-300" />
                <span className="text-xs font-bold text-slate-600 dark:text-slate-300">Team Chat - Marketplace App</span>
              </div>
              <div className="space-y-2">
                <div className="flex gap-2">
                  <img src="https://i.pravatar.cc/150?img=32" className="h-6 w-6 shrink-0 rounded-full" alt="avatar" />
                  <div className="rounded-r-lg rounded-bl-lg bg-slate-100 dark:bg-slate-700 px-3 py-2 text-xs text-slate-700 dark:text-slate-300">Anyone ready to start on the Auth flow?</div>
                </div>
...
function TickerSection() {
  return (
    <div className="border-y border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 py-3 overflow-hidden flex">
      <motion.div 
        className="flex whitespace-nowrap gap-10 px-10 text-xs font-semibold text-slate-600 dark:text-slate-300"
        animate={{ x: ["0%", "-50%"] }}
    ...
    <section className="border-y border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 py-8">
      <div className="mx-auto max-w-[1280px] px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-8">
          {tags.map((tag) => (
            <div key={tag} className="rounded-full border border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-6 py-2.5 text-sm font-semibold text-slate-600 dark:text-slate-300 shadow-sm transition-colors hover:border-slate-200 dark:hover:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-700">
              {tag}
            </div>
          ))}
        </div>
    ...
    <section className="bg-slate-50 dark:bg-slate-950 py-16">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-8">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 lg:row-span-2 flex flex-col justify-between group rounded-3xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-7 transition-all hover:shadow-xl hover:shadow-violet-600/10">
            <div>
              <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400">
                <Users size={28} strokeWidth={2.5} />
              </div>
              <h3 className="text-2xl font-black text-slate-900 dark:text-slate-100">Find Teammates</h3>
              <p className="mt-3 text-base leading-relaxed text-slate-600 dark:text-slate-300 max-w-md">Discover students with the exact skills you need for your next big idea. Filter by major, technical stack, or interests.</p>
            </div>
            <div className="mt-8 overflow-hidden rounded-2xl border border-slate-100 dark:border-slate-700 shadow-inner h-40 bg-slate-50 dark:bg-slate-900 flex items-center justify-center relative">
          ...
          {/* Discover Events */}
          <div className="group rounded-3xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-7 transition-all hover:shadow-xl hover:shadow-violet-600/10">
            <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-100 dark:bg-emerald-900/50 text-emerald-600 dark:text-emerald-400">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-slate-300">Never miss a campus hackathon, workshop, or tech meetup again.</p>
          </div>
          ...
          {/* Build Projects */}
          <div className="lg:col-span-3 group flex flex-col md:flex-row items-center gap-7 rounded-3xl border border-violet-100 dark:border-violet-900/50 bg-violet-50 dark:bg-violet-900/20 p-7 transition-all hover:shadow-xl hover:shadow-violet-600/10">
             <div className="flex-1">
               <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-violet-600 text-white">
                <Rocket size={28} strokeWidth={2.5} />
              </div>
              <h3 className="text-2xl font-black text-slate-900 dark:text-slate-100">Build Projects & Portfolio</h3>
              <p className="mt-3 text-base leading-relaxed text-slate-600 dark:text-slate-300">Collaborate effectively, showcase your work, and build a stellar portfolio that lands you opportunities.</p>
             </div>
             <div className="w-full md:w-1/3 mt-4 md:mt-0">
               <div className="rounded-2xl bg-white dark:bg-slate-800 p-5 shadow-sm border border-violet-100 dark:border-violet-900/50">
                  <div className="flex gap-2 mb-3">
                    <span className="h-2.5 w-12 rounded-full bg-violet-200 dark:bg-violet-700"/>
                    <span className="h-2.5 w-8 rounded-full bg-blue-200 dark:bg-blue-700"/>
                  </div>
                  <div className="h-20 w-full rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-700 mb-3 flex items-center justify-center text-slate-300 dark:text-slate-600">
                    <Code2 size={24} />
                  </div>
    ...
    <section id="platform" className="overflow-hidden bg-slate-900 dark:bg-slate-950 py-16 text-white">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-8">
        <div className="mb-10 text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-base text-slate-400 dark:text-slate-300">See how CoDO helps students collaborate, network, and grow their careers.</p>
        </div>

        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          
          {/* Large Student Profile */}
          <div className="flex flex-col rounded-3xl border border-slate-800 dark:border-slate-700 bg-slate-950/50 dark:bg-slate-900/50 p-6 lg:col-span-2">
            <div className="mb-6">
              <h3 className="flex items-center gap-2 text-xl font-bold text-white"><UserCheck className="text-violet-400"/> Student Profile</h3>
              <p className="mt-2 text-sm text-slate-400 dark:text-slate-300">Showcase skills, projects, achievements and interests to help teammates find you.</p>
            </div>
            
            <div className="mt-auto rounded-xl border border-slate-800 dark:border-slate-700 bg-slate-900 dark:bg-slate-800 p-6 shadow-2xl">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                <img src="https://i.pravatar.cc/150?img=68" alt="Profile" className="h-20 w-20 rounded-full border-4 border-slate-800 dark:border-slate-700 object-cover" />
                <div className="flex-1">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    <span className="rounded-md bg-slate-800 dark:bg-slate-700 px-3 py-1 text-xs font-semibold text-slate-300">Frontend Dev</span>
                    <span className="rounded-md bg-slate-800 dark:bg-slate-700 px-3 py-1 text-xs font-semibold text-slate-300">React</span>
          ...
          {/* Team Recruitment */}
          <div className="flex flex-col rounded-3xl border border-slate-800 dark:border-slate-700 bg-slate-950/50 dark:bg-slate-900/50 p-6">
            <div className="mb-6">
              <h3 className="flex items-center gap-2 text-xl font-bold text-white"><Target className="text-rose-400"/> Team Recruitment</h3>
              <p className="mt-2 text-sm text-slate-400 dark:text-slate-300">Find the perfect candidates for your projects with precision matching.</p>
            </div>
              ...
              <div className="rounded-xl border border-slate-800 dark:border-slate-700 bg-slate-900 dark:bg-slate-800 p-4 transition-colors hover:bg-slate-800/80 dark:hover:bg-slate-700/80">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-xs text-slate-400 dark:text-slate-300 mt-1">Project: AI Resume Builder</p>
                  </div>
              ...
              <div className="rounded-xl border border-slate-800 dark:border-slate-700 bg-slate-900 dark:bg-slate-800 p-4 transition-colors hover:bg-slate-800/80 dark:hover:bg-slate-700/80">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-xs text-slate-400 dark:text-slate-300 mt-1">Project: Green Campus</p>
                  </div>
                  <span className="bg-emerald-50 dark:bg-emerald-500/200/10 text-emerald-400 text-[10px] font-bold px-2 py-1 rounded">Open</span>
                </div>
              </div>
          ...
          <div className="flex flex-col rounded-3xl border border-slate-800 dark:border-slate-700 bg-slate-950/50 dark:bg-slate-900/50 p-6 lg:col-span-2">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-slate-400 dark:text-slate-300">Coordinate with your teammates directly without ever switching apps.</p>
            </div>
            
            <div className="mt-auto rounded-xl border border-slate-800 dark:border-slate-700 bg-slate-900 dark:bg-slate-800 p-6">
               <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-800 dark:border-slate-700">
                  <div className="flex -space-x-2">
                    <img src="https://i.pravatar.cc/150?img=32" className="h-8 w-8 rounded-full border-2 border-slate-900 dark:border-slate-700" alt="team" />
                    <img src="https://i.pravatar.cc/150?img=12" className="h-8 w-8 rounded-full border-2 border-slate-900 dark:border-slate-700" alt="team" />
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <div className="rounded-2xl rounded-tl-sm bg-slate-800 dark:bg-slate-700 p-3 text-sm text-slate-300">
          ...
          <div className="flex flex-col rounded-3xl border border-slate-800 dark:border-slate-700 bg-slate-950/50 dark:bg-slate-900/50 p-6">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-slate-400 dark:text-slate-300">Never miss out on hackathons, workshops, and meetups.</p>
            </div>
            ...
            <div className="mt-auto rounded-xl border border-slate-800 dark:border-slate-700 bg-slate-900 dark:bg-slate-800 overflow-hidden">
              ...
              <div className="p-4">
                <p className="text-xs text-slate-400 font-bold mb-1">Oct 24-26 • Hybrid</p>
                <p className="text-sm text-slate-300 dark:text-slate-200 line-clamp-2">Join us for a 48-hour sprint to build the next generation of campus tools.</p>
                <div className="mt-4 flex items-center justify-between">
                  <div className="flex -space-x-2">
                   <img src="https://i.pravatar.cc/150?img=1" className="h-6 w-6 rounded-full border border-slate-900 dark:border-slate-700" alt="attendee" />
        ...
        <div className="mt-12 text-center">
          ...
          <Link to="/signup" className="inline-block rounded-xl bg-violet-600 px-7 py-3 text-base font-bold text-white shadow-lg shadow-violet-600/30 transition-colors hover:bg-violet-500 dark:hover:bg-violet-400">
            Join Free Today
          </Link>
        </div>
    ...
    <section className="bg-white dark:bg-slate-900 py-16">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-8">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {reasons.map((r, i) => (
            <div key={i} className="group flex flex-col rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 p-6 transition-all hover:bg-white dark:hover:bg-slate-700 hover:shadow-lg hover:shadow-violet-600/10 hover:border-violet-200 dark:hover:border-violet-700">
              <div className="mb-4 flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-white dark:bg-slate-900 shadow-sm border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 transition-colors group-hover:bg-violet-600 group-hover:text-white group-hover:border-violet-600">
                <r.icon size={22} strokeWidth={2.5} />
              </div>
              <h4 className="text-lg font-black text-slate-900 dark:text-slate-100">{r.title}</h4>
              <p className="mt-2 text-sm font-medium text-slate-600 dark:text-slate-300 leading-relaxed">{r.desc}</p>
            </div>
          ))}
        </div>
      </div>
    ...
    <section className="bg-white dark:bg-slate-900 py-16">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-8">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {/* Students */}
          <div className="flex flex-col rounded-3xl border border-violet-100 dark:border-violet-900/50 bg-violet-50 dark:bg-violet-900/30 p-6 sm:p-8">
            ...
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">Accelerate your learning, build a real-world portfolio, and network with peers.</p>
            ...
            <ul className="mt-5 mb-7 flex-1 space-y-2.5">
              {["Find teammates", "Discover projects", "Join campus events", "Connect with students", "Showcase your skills", "Build your network"].map(item => (
                <li key={item} className="flex items-center gap-3 text-sm font-semibold text-slate-700 dark:text-slate-200">
                  <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-violet-200 dark:bg-violet-700 text-violet-700 dark:text-violet-200"><Check size={11} /></div>
                  {item}
                </li>
              ))}
            </ul>
            
            <Link to="/signup" className="mt-auto block w-full rounded-xl bg-violet-600 px-5 py-3 text-center text-sm font-bold text-white transition-colors hover:bg-violet-700 dark:hover:bg-violet-500">Join as Student</Link>
          </div>

          {/* Organizations */}
          <div className="flex flex-col rounded-3xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 sm:p-8 shadow-lg shadow-slate-200/50 dark:shadow-slate-900/50">
            ...
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">Connect with talented students, promote your initiatives, and build stronger campus communities.</p>
            ...
            <ul className="mt-5 mb-7 flex-1 space-y-2.5">
              {["Find talented students", "Connect with active communities", "Build stronger teams", "Reach the right audience", "Grow your campus presence", "Discover future leaders"].map(item => (
                <li key={item} className="flex items-center gap-3 text-sm font-semibold text-slate-700 dark:text-slate-200">
                  <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-200"><Check size={11} /></div>
                  {item}
                </li>
              ))}
            </ul>
            
            <Link to="/signup?type=org" className="mt-auto block w-full rounded-xl bg-slate-900 px-5 py-3 text-center text-sm font-bold text-white transition-colors hover:bg-slate-800 dark:hover:bg-slate-700">Register Organization</Link>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="bg-white dark:bg-slate-900 py-16">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-8">
        <div className="mb-8 text-center max-w-3xl mx-auto">
          <p className="text-sm font-semibold text-slate-600 dark:text-slate-300">Check out what's happening right now in the CoDO ecosystem.</p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          {/* Featured Event */}
          <div>
            <h4 className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400">Featured Event</h4>
            <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 overflow-hidden shadow-sm flex flex-col h-[320px]">
              ...
              <div className="p-6 bg-white dark:bg-slate-800 flex-1 flex flex-col justify-between">
                <div>
                ...
                <div className="flex items-center justify-between mt-4">
                  <div className="flex -space-x-2">
                    {[1,2,3].map(i => (
                      <div key={i} className="h-7 w-7 rounded-full bg-slate-200 dark:bg-slate-700 border-2 border-white dark:border-slate-800" />
                    ))}
                    <div className="flex h-7 w-7 items-center justify-center rounded-full bg-violet-600 border-2 border-white dark:border-slate-800 text-[8px] font-bold text-white">
                      +42
                    </div>
                  </div>
          ...
          {/* Open Roles */}
          <div>
            <h4 className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400">Open Roles</h4>
            <div className="flex flex-col gap-4">
              {roles.map((role, i) => (
                <div key={i} className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm flex items-center justify-between">
                  <div>
          ...
          {/* Active Student */}
          <div>
            <h4 className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400">Active Student</h4>
            <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 shadow-sm h-[320px] flex flex-col">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {["React", "Node.js", "AWS", "Python"].map(skill => (
                  <span key={skill} className="rounded bg-slate-100 dark:bg-slate-700 px-2.5 py-1 text-[10px] font-semibold text-slate-600 dark:text-slate-300">
                    {skill}
                  </span>
                ))}
              </div>
              ...
              <div className="flex justify-around text-center mb-auto">
                <div>
                  <p className="text-lg font-bold text-violet-700 dark:text-violet-400">12</p>
                  <p className="text-[9px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 mt-1">Projects</p>
                </div>
                <div>
                  <p className="text-lg font-bold text-violet-700 dark:text-violet-400">850+</p>
    ...
    <section className="bg-slate-900 dark:bg-slate-950 py-16 text-white">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="mt-4 text-base text-slate-400 dark:text-slate-300">Your journey from student to shipped product.</p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-4">
          {steps.map((step, index) => (
            <div key={step.title} className="relative">
              ...
              <div className="relative z-10 mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-slate-800 dark:bg-slate-700 border border-slate-700 dark:border-slate-600 text-xl font-black text-violet-400">
                {index + 1}
              </div>
              <h4 className="text-lg font-bold text-white mb-2">{step.title}</h4>
              <p className="text-sm text-slate-400 dark:text-slate-300 leading-relaxed">{step.desc}</p>
            </div>
          ))}
        </div>
      </div>
    ...
    <section className="bg-white dark:bg-slate-900 py-16">
      <div className="mx-auto max-w-4xl px-6 xl:px-8">
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700">
          <div className="grid grid-cols-2 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 p-4 text-sm font-bold uppercase tracking-wider text-slate-400 dark:text-slate-300">
            <div>Other Platforms</div>
            <div className="text-violet-600">CoDO</div>
          </div>
          <div className="divide-y divide-slate-100 dark:divide-slate-700">
            {comparisons.map((row, i) => (
              <div key={i} className="grid grid-cols-2 px-4 py-3.5 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                <div className="flex items-center gap-2 text-sm text-slate-400 dark:text-slate-300">
                  <span className="text-slate-300 dark:text-slate-500">✕</span> {row.other}
                </div>
      ...
      <div className="mx-auto grid max-w-[1280px] gap-6 px-6 text-center sm:grid-cols-2 lg:grid-cols-4 xl:px-8">
        {statsList.map((stat, i) => (
          <div key={i}>
            ...
            <p className="mt-2 text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400">{stat.label}</p>
          </div>
        ))}
      </div>
    </section>
    ...
    <section className="bg-slate-50 dark:bg-slate-800/50 py-16">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-8">
        ...
        <div className="mx-auto max-w-2xl rounded-3xl bg-gradient-to-br from-violet-600 to-fuchsia-600 p-1">
          <div className="rounded-[23px] bg-white dark:bg-slate-800 p-8 text-center shadow-xl">
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-violet-100 dark:bg-violet-900/50 text-2xl">🚀</div>
            <h3 className="text-2xl font-black text-slate-900 dark:text-slate-100">Your Success Story Could Be Here</h3>
            <div className="mt-5 space-y-2 text-base font-semibold text-slate-600 dark:text-slate-300">
            ...
            <Link to="/signup" className="mt-6 inline-block rounded-xl bg-slate-900 dark:bg-slate-700 px-7 py-3 font-bold text-white transition-colors hover:bg-slate-800 dark:hover:bg-slate-600">Start Your Story</Link>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="bg-white dark:bg-slate-900 py-16">
      <div className="mx-auto max-w-3xl px-6 xl:px-8">
        ...
        <div className="space-y-3">
          {faqs.map((q, index) => (
            <div key={index} className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 overflow-hidden transition-all hover:border-violet-200 dark:hover:border-violet-700">
              <button 
              ...
              >
                {q}
                <ChevronDown size={18} className={`shrink-0 text-slate-400 dark:text-slate-300 transition-transform duration-200 ${openFaq === index ? "rotate-180 text-violet-600" : ""}`} />
              </button>
              <AnimatePresence>
                {openFaq === index && (
                  <motion.div 
                  ...
                  >
                    <p className="border-t border-slate-100 dark:border-slate-700 px-5 py-4 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">{getAnswer(q)}</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
      ...
      <div className="mx-auto max-w-[1280px]">
        <div className="relative overflow-hidden rounded-3xl bg-slate-900 dark:bg-slate-950 px-6 py-16 text-center text-white shadow-2xl md:px-16">
          ...
          <div className="relative z-10 mx-auto max-w-3xl">
            ...
            <p className="mt-4 text-base leading-relaxed text-slate-300 dark:text-slate-400">
              Join CoDO today and connect with students who are ready to build, learn, and grow together.
            </p>
            <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
              <Link to="/signup" className="rounded-xl bg-violet-600 px-7 py-3.5 text-base font-bold text-white shadow-lg shadow-violet-600/25 transition-colors hover:bg-violet-500 dark:hover:bg-violet-400">
                Join as Student
              </Link>
              <Link to="/signup?type=org" className="rounded-xl bg-white px-7 py-3.5 text-base font-bold text-slate-900 transition-colors hover:bg-slate-100 dark:bg-slate-700 dark:text-slate-100 dark:hover:bg-slate-600">
