...
function SkeletonPost() {
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm p-6 animate-pulse">
      {/* Header */}
    ...
    <div className="animate-in fade-in duration-500 bg-slate-50/50 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                ...
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`whitespace-nowrap text-sm font-bold px-4 py-2.5 rounded-xl transition-all duration-200 focus:outline-none ${filter === tab
                      ...
                      : 'bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-800'
                      }`}
                  >
                    {tab}
                  </button>
            ...
            <div className="relative shrink-0" ref={dropdownRef}>
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-1.5 z-50 animate-in fade-in zoom-in-95 duration-150">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-10">
        ...
        {isLoading ? (
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-3xl p-12 text-center flex flex-col items-center justify-center min-h-[400px] shadow-sm">
            <div className="w-20 h-20 bg-slate-50 dark:bg-slate-950 text-slate-300 rounded-[24px] flex items-center justify-center mb-6 ring-8 ring-slate-50/50">
              <LayoutGrid size={40} />
            </div>
